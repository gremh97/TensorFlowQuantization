...
def keras_model_loader(model_name):
    ...
    KerasModels = {
        ...
        "efficientnetv2b0": ["efficientnet_v2", "EfficientNetV2B0", {"include_preprocessing": False}, lambda x: x/127.5-1],
        "efficientnetv2b1": ["efficientnet_v2", "EfficientNetV2B1", {"include_preprocessing": False}, lambda x: x/127.5-1],
        "efficientnetv2b2": ["efficientnet_v2", "EfficientNetV2B2", {"include_preprocessing": False}, lambda x: x/127.5-1],
        "efficientnetv2b3": ["efficientnet_v2", "EfficientNetV2B3", {"include_preprocessing": False}, lambda x: x/127.5-1],
